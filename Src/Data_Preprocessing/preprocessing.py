...
def preprocess_data(input_dir, output_dir, target_fs=1000, resample_data=False):
    ...
    if not os.path.exists(label_output_dir):
        # If it doesn't exist, copy the tree
...
if __name__ == "__main__":
    ...
    # Basic path for Google Colab 
    basic_path = "/content/drive/MyDrive/Colab Notebooks/ECG_Classifier_Farshid/data"

    # Set the paths to your raw data directory and the directory where you want to save preprocessed data
    raw_data_dir = os.path.join(basic_path, "raw/training2017")
    output_data_dir = os.path.join(basic_path, "processed/training2017")

    # Preprocess data with resampling
    preprocess_data(raw_data_dir, output_data_dir)
